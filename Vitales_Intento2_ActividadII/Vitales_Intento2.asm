...
; Declaro las variables de los registros a usar
	...
	LD E, 0  ; Inicio en 0 al registro E (Este será el que se compare
...
LOOP:
	...
	LD A, E  ; Cargo  el valor de mi estimación (E) en A
	ADD A, A ; Sumo lo que hay en A (en este caso, el registro E) en A.
	ADD A, E ; Sumo lo que hay en E a A. Esto me generará que A valga
		 ; 3 veces lo que hay en el estimador (A = 3E).
	LD L, A  ; Guardo el valor actual de A (3E) en este registro (L)
	...
	CP L	 ; Comparo lo que hay en mi registro actual (A) con lo que hay en L.
		 ; En este caso, 3E.
	JR C, END; Si el D es menor que L (3E), ejecuta END.
...
END:
	LD C, E  ; Para terminar, guarda el valor de E en el registro C.
	RET
